...
export class InitialSchema1769595579285 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."jobs_job_type_enum" AS ENUM('script', 'audio', 'caption', 'asset', 'render')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."assets_asset_type_enum" AS ENUM('video', 'image', 'audio', 'caption')`,
    );
    await queryRunner.query(
      `CREATE TABLE "assets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "video_id" uuid NOT NULL, "asset_type" "public"."assets_asset_type_enum" NOT NULL, "s3_url" text NOT NULL, "s3_key" text NOT NULL, "metadata" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_da96729a8b113377cfb6a62439c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."users_auth_provider_enum" AS ENUM('email', 'google', 'microsoft')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."videos_status_enum" AS ENUM('pending', 'script_generating', 'script_complete', 'processing', 'rendering', 'completed', 'failed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "jobs" ADD CONSTRAINT "FK_eace0b43b8161a17b423f826e01" FOREIGN KEY ("video_id") REFERENCES "videos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "assets" ADD CONSTRAINT "FK_6b186028f5b00484d3498504f2a" FOREIGN KEY ("video_id") REFERENCES "videos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "assets" DROP CONSTRAINT "FK_6b186028f5b00484d3498504f2a"`,
    );
