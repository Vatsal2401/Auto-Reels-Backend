...
import { writeFileSync, readFileSync, existsSync, readdirSync, unlinkSync, createWriteStream, statSync } from 'fs';
    ...
    async compose(options: ComposeOptions): Promise<Readable> {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (assetPaths.length > 0) {
                ...
                command
                    .input('color=c=black:s=720x1280:d=' + (audioDuration || 30))
                    .inputFormat('lavfi');
