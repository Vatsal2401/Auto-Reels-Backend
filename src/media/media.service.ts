...
export class MediaService {
    ...
    async retryMedia(id: string): Promise<Media> {
        ...
        const stepsToReset = media.steps.filter(s => s.status === StepStatus.FAILED || s.status === StepStatus.PENDING);
    ...
    async addAsset(mediaId: string, type: MediaAssetType, blobId: string, metadata?: any): Promise<MediaAsset> {
